...
Certain features or services offered through the App may be subject to additional terms and conditions. These additional terms will be disclosed to you when you access the relevant feature or service. By using those features or services, you agree to the additional terms.
...
DMCA notices can be sent to: dmca@recipeforlater.com
...
The App, including its design, graphics, text, and other content (excluding Imported Content and User Content), is owned by us and is protected by copyright, trademark, and other intellectual property laws. You may not use our intellectual property without our prior written consent.
...
### 10.4 Allergen and Dietary Information Disclaimer

**IMPORTANT: ALLERGEN WARNING**

The App may use AI technology to identify and flag potential allergens in recipes. However, you acknowledge and agree that:

**No Guarantee of Accuracy:**
- AI-based allergen detection is NOT 100% accurate and may contain errors, omissions, or inaccuracies
- Allergen information may be incomplete, outdated, or incorrect
- Cross-contamination risks are not detected or analyzed by our App
- Hidden allergens in processed ingredients may not be identified

**Your Responsibility:**
- YOU ARE SOLELY RESPONSIBLE for verifying all ingredient information before consuming any food
- YOU MUST independently verify allergen information for all ingredients, especially if you have food allergies or dietary restrictions
- YOU MUST read all product labels and ingredient lists yourself
- YOU MUST consult with healthcare professionals regarding your specific dietary needs and allergies

**Life-Threatening Allergies:**
- If you have life-threatening food allergies (such as peanuts, tree nuts, shellfish, etc.), DO NOT rely on the App's allergen detection
- ALWAYS verify ingredients independently and consult original sources
- ALWAYS carry appropriate emergency medication (such as an EpiPen)

**No Medical Advice:**
- The App does not provide medical advice
- Allergen information is for informational purposes only
- Consult with your doctor, allergist, or dietitian for personalized dietary guidance

**Imported Content:**
- Allergen information for imported recipes is based on third-party content and may be inaccurate
- We do not verify or validate allergen information from external sources
- Original recipe sources may have errors or omissions

**AI Processing Limitations:**
- AI may misidentify ingredients or fail to detect allergens
- AI cannot detect preparation methods that may introduce allergens (e.g., using the same cutting board)
- AI cannot account for regional variations in ingredient composition
- AI databases may not include all possible allergens or ingredients

**Disclaimer of Liability:**
- WE EXPRESSLY DISCLAIM ALL LIABILITY for any allergic reactions, adverse health effects, or injuries resulting from your use of the App's allergen detection features
- WE ARE NOT RESPONSIBLE for any harm caused by inaccurate, incomplete, or missing allergen information
- YOU ASSUME ALL RISKS associated with using the App's allergen detection features

**User Modifications:**
- If you modify recipes or add custom ingredients, YOU are responsible for updating allergen information
- The App may not automatically detect allergens in user-added content

BY USING THE APP'S ALLERGEN DETECTION FEATURES, YOU ACKNOWLEDGE THAT YOU HAVE READ THIS DISCLAIMER, UNDERSTAND THE LIMITATIONS AND RISKS, AND AGREE TO INDEPENDENTLY VERIFY ALL ALLERGEN INFORMATION BEFORE CONSUMING ANY FOOD.
...
### 11.3 Specific Disclaimer for Allergen-Related Claims

WITHOUT LIMITING THE GENERALITY OF THE FOREGOING, WE SPECIFICALLY DISCLAIM ALL LIABILITY FOR:

- Any allergic reactions, anaphylaxis, or other adverse health effects resulting from consuming food prepared using recipes or information from the App
- Any injuries, illnesses, or deaths resulting from allergen exposure related to recipes in the App
- Any inaccuracies, errors, or omissions in allergen information provided by the App, whether generated by AI or imported from third-party sources
- Any failure of the App's AI-based allergen detection to identify allergens
- Any cross-contamination or hidden allergens not detected by the App
- Any reliance on the App's allergen information for medical or dietary decisions

YOU EXPRESSLY ACKNOWLEDGE AND AGREE THAT YOUR USE OF THE APP'S ALLERGEN DETECTION FEATURES IS AT YOUR SOLE RISK AND THAT YOU ARE SOLELY RESPONSIBLE FOR VERIFYING ALL ALLERGEN INFORMATION INDEPENDENTLY.
...
- Any allergic reactions, adverse health effects, injuries, or illnesses resulting from your use of recipes or allergen information from the App
- Your reliance on the App's allergen detection features or dietary information
- Any claims by third parties related to food prepared using recipes from the App
